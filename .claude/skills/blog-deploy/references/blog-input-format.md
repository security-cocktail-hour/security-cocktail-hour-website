...
The blog post deployment skill requires content information in a structured format with 8 numbered fields. This document specifies the exact format, requirements, and examples for the `working/blog-answers.txt` file.

**Note:** Key Takeaways are auto-generated by the skill from the article content and presented for approval at Checkpoint 1. They do not need to be provided in the input file.
...
2. Skill reads and parses the 8 numbered fields
3. Auto-generates SEO metadata (including Key Takeaways) from provided content
